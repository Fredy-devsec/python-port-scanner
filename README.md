...
> ⚠️ **Educational Project:** This tool was created for learning purposes. Only scan systems, devices, networks, virtual machines, or environments that you own or have explicit permission to test.
...
ScanFredy is a learning project, not a professional network scanner.
...
ScanFredy does not attempt to exploit discovered services.
...
<h3 align="center">⚡ Think like a hacker. Build like an engineer. ⚡</h3> <p align="center"> <i>Built for learning. Improved through practice.</i> </p> ```
